...
<body>
    ...
    <ul class="nav nav-tabs nav-justified">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle active" data-toggle="dropdown" href="#"><i class="fas fa-building fa-lg"></i> Tentang</a>
            <div class="dropdown-menu w-100 active">
                <a class="dropdown-item active" href="#">Tentang Kami</a>
    ...
    <h1 style="text-align: center;font-size: 72px;">Balai Latihan Kerja Wonosobo</h1>
    <hr style="border: 1px solid black;">
    <img src="gambar/blk-icon2.png" width="300" height="325" style="float: right;margin: 0 10px 0 20px;border-radius: 2px;">
    <p style="font-weight: 400; text-align: justify;margin-left: 10px;">
        Captain Jack terbentuk di Yogyakarta, 4 Desember 1999. Merupakan sebuah grup musik beraliran rock
        alternatif yang beranggotakan Momo, Zuhdil "Sancho",Ismeth, Novan, Andi "Babon". Mereka berlima
        awalnya berasal dari satu Kota Kecil di Kalimantan,tepatnya di Pontianak dan pindah ke Jogja untuk
        melanjutkan program pendidikan.Namun diluar akademinya,dengan memiliki hobi yang sama antara satu
        sama lain dan mereka membentuk suatu komitmen, maka terbentuklah Grup Band Captain Jack.
        Latar Belakang terbentuknya Captain Jack ini yaitu sebagai wadah untuk mereka pulang dan untuk
        menumpahkan segala emosi serta pikiran dari yang terkonsep sampai yang tidak terkonsep.Tidak ada
        filosofi atas terciptanya nama 'Captain Jack'. Karena pada dasarnya mereka tidak ingin memberikan
        sebuah nama dengan embel-embel filosofi.Mereka ingin lebih berfilosofi lewat karya. Alasan mereka
        menggunakan nama 'Captain Jack',karena simple, dan mudah diingat.
