...
<body>
    ...
    <ul class="nav nav-tabs nav-justified">
        <li class="nav-item">
            <a class="nav-link active" href="#"><i class="fas fa-home fa-lg"></i> Home</a>
        </li>
        <li class="nav-item">
    ...
    <h1 style="text-align: center;font-size: 72px;">SELAMAT DATANG</h1>
    <hr style="border: 1px solid black;">
    <img class="pic-1" src="gambar/blk-1.jpg" width="300" height="auto" style="border: 2px solid; border-radius: 3px;">
    <p style="font-weight: 400; text-align: justify;margin-right: 10px;">
